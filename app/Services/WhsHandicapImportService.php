...
class WhsHandicapImportService
{
    ...
    public function import($request)
    {
        ...
        try {
            ...
            return [
                'success' => true,
                'message' => "Import completed. " . count($validationResult['validRows']) . " players imported successfully.",
                'imported' => count($validationResult['validRows']),
                'errors' => $validationResult['errors']
            ];
        } catch (Exception $e) {

            Log::error('WHS Handicap Import failed: ' . $e->getMessage(), [
                'file' => $e->getFile(),
                'line' => $e->getLine(),
            ...
            return [
                'success' => false,
                'message' => 'Import failed. Please try again later. ' . $e->getMessage(),
                'line' => $e->getLine(),
                'file' => $e->getFile(),
            ];
        }
