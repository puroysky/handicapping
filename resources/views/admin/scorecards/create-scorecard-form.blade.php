                    ...
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 scorecard-section-card" style="background: #fff; border: 1px solid #e0e8d8;">
                        <div class="card-header py-2 px-4 d-flex align-items-center justify-content-between" style="background: #f8fafc; color: #2F4A3C; border-bottom: 1px solid #e0e8d8;">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <span class="fw-bold" style="font-size: 1.15rem; color: #2F4A3C;">Course & Slope Ratings</span>
                            </div>
                            <span class="badge" style="background-color: #e0e8d8; color: #5E7C4C;">Rating Configuration</span>
                        </div>
                        <div class="card-body p-4">
                            @if($scorecard->ratings->isNotEmpty())
                            <!-- Overall Ratings Section -->
                            <div class="mb-4">
                                <h6 class="fw-bold mb-3" style="color: #2F4A3C; border-bottom: 2px solid #5E7C4C; padding-bottom: 0.5rem;">
                                    ...
                                    <table class="table table-borderless align-middle mb-0">
                                        <thead>
                                            <tr style="background-color: #f0f4f0;">
                                                <th class="text-uppercase text-muted small fw-bold" style="color: #2F4A3C; width: 15%; padding: 0.75rem;">Tee</th>
                                                @foreach($scorecard->ratings as $rating)
                                                <th class="text-center" style="padding: 0.75rem;">
                                                    <div class="fw-bold" style="color: #2F4A3C; font-size: 0.95rem;">{{ $rating->tee->tee_name }}</div>
                                                    <small style="color: #8DA66E;">Tee Name</small>
                                                </th>
                                                @endforeach
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td class="fw-bold" style="color: #5E7C4C; padding: 0.75rem;">Course Rating</td>
                                                @foreach($scorecard->ratings as $rating)
                                                <td class="text-center" style="padding: 0.75rem;">
                                                    <input type="number" step="0.1" class="form-control form-control-sm" name="course_rating[{{ $rating->tee->tee_id }}]" value="{{ $rating->course_rating }}" placeholder="0.0" style="max-width: 100%; border: 2px solid #e0e8d8; border-radius: 6px; text-align: center;" title="Overall Course Rating">
                                                </td>
                                                @endforeach
                                            </tr>
                                            <tr style="background-color: #f8fafc;">
                                                <td class="fw-bold" style="color: #5E7C4C; padding: 0.75rem;">Slope Rating</td>
                                                @foreach($scorecard->ratings as $rating)
                                                <td class="text-center" style="padding: 0.75rem;">
                                                    <input type="number" step="1" class="form-control form-control-sm" name="slope_rating[{{ $rating->tee->tee_id }}]" value="{{ $rating->slope_rating }}" placeholder="0" style="max-width: 100%; border: 2px solid #e0e8d8; border-radius: 6px; text-align: center;" title="Overall Slope Rating">
                                                </td>
                                                @endforeach
                                            </tr>
                                        </tbody>
                            ...
                            <div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless align-middle mb-0">
                                        <thead>
                                            <tr style="background-color: #f0f4f0;">
                                                <th class="text-uppercase text-muted small fw-bold" style="color: #2F4A3C; width: 15%; padding: 0.75rem;">Side</th>
                                                @foreach($scorecard->ratings as $rating)
                                                <th colspan="2" class="text-center fw-bold" style="color: #2F4A3C; padding: 0.75rem;">
                                                    {{ $rating->tee->tee_name }}
                                                    <br>
                                                    <small style="color: #8DA66E; font-weight: normal;">CR / SR</small>
                                                </th>
                                                @endforeach
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr style="background-color: #f0fdf4;">
                                                <td class="fw-bold" style="color: #5E7C4C; padding: 0.75rem;">
                                                    <i class="fas fa-play me-2" style="color: #2F4A3C;"></i>Front 9
                                                </td>
                                                @foreach($scorecard->ratings as $rating)
                                                <td style="padding: 0.75rem;">
                                                    <input type="number" step="0.1" class="form-control form-control-sm" name="front_nine_course_rating[{{ $rating->tee->tee_id }}]" value="{{ ($rating->course_rating / 2) ?? 35.5 }}" placeholder="CR" style="max-width: 100%; border: 2px solid #8DA66E; border-radius: 6px; text-align: center; background-color: #f9fdf8;" title="Front 9 Course Rating">
                                                </td>
                                                <td style="padding: 0.75rem;">
                                                    <input type="number" step="1" class="form-control form-control-sm" name="front_nine_slope_rating[{{ $rating->tee->tee_id }}]" value="{{ ($rating->slope_rating / 2) ?? 130 }}" placeholder="SR" style="max-width: 100%; border: 2px solid #8DA66E; border-radius: 6px; text-align: center; background-color: #f9fdf8;" title="Front 9 Slope Rating">
                                                </td>
                                                @endforeach
                                            </tr>
                                            <tr style="background-color: #fdf8f0;">
                                                ...
                                                @foreach($scorecard->ratings as $rating)
                                                <td style="padding: 0.75rem;">
                                                    <input type="number" step="0.1" class="form-control form-control-sm" name="back_nine_course_rating[{{ $rating->tee->tee_id }}]" value="{{ ($rating->course_rating / 2) ?? 35.5 }}" placeholder="CR" style="max-width: 100%; border: 2px solid #8DA66E; border-radius: 6px; text-align: center; background-color: #fdfcf9;" title="Back 9 Course Rating">
                                                </td>
                                                <td style="padding: 0.75rem;">
                                                    <input type="number" step="1" class="form-control form-control-sm" name="back_nine_slope_rating[{{ $rating->tee->tee_id }}]" value="{{ ($rating->slope_rating / 2) ?? 130 }}" placeholder="SR" style="max-width: 100%; border: 2px solid #8DA66E; border-radius: 6px; text-align: center; background-color: #fdfcf9;" title="Back 9 Slope Rating">
                                                </td>
                                                @endforeach
                                            </tr>
                                        </tbody>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 scorecard-section-card" style="background: #fff; border: 1px solid #e0e8d8;">
                        <div class="card-header py-2 px-4 d-flex align-items-center justify-content-between" style="background: #f8fafc; color: #2F4A3C; border-bottom: 1px solid #e0e8d8;">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <span class="fw-bold" style="font-size: 1.15rem; color: #2F4A3C;">Tee Yardages</span>
                            </div>
                            <span class="badge" style="background-color: #e0e8d8; color: #5E7C4C;">Distance by Tee</span>
                        </div>
                        <div class="card-body p-4">
                            <div class="table-responsive">
                                <table class="table table-bordered align-middle text-center mb-0 table-hover scorecard-table" style="min-width: 1100px;">
                                    <thead style="background: #f0f4f0; color: #2F4A3C;">
                                        <tr>
                                            <th class="fw-bold" style="color: #5E7C4C; background: #e8e8e8;">Tee</th>
                                            @php
                                            ...
                                            <th style="background: #f0f4f0; font-size: 0.9rem;">{{ $hole }}</th>
                                            @endforeach
                                            <th style="background: #8DA66E; color: #fff; font-weight: bold;">OUT</th>
                                            @foreach($backNine as $hole)
                                            <th style="background: #f0f4f0; font-size: 0.9rem;">{{ $hole }}</th>
                                            @endforeach
                                            <th style="background: #8DA66E; color: #fff; font-weight: bold;">IN</th>
                                            <th style="background: #2F4A3C; color: #8DA66E; font-weight: bold;">TOTAL</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {{-- Tee Yardage Rows --}}
                                        ...
                                        <tr class="tee-row" data-tee-id="{{ $tee->tee_id }}" style="background-color: #f9faf9;">
                                            <td class="fw-bold" style="color: #5E7C4C; background: #e8e8e8;">{{ $tee->tee_name }}</td>
                                            @foreach ($yardages[$tee->tee_id] as $hole => $yardage)
                                            <td style="color: #333; padding: 0.5rem;">
                                                <input type="number" value="{{ $yardage }}" class="form-control form-control-sm scorecard-input tee-yardage-input" name="yardages[{{ $tee->tee_id }}][{{ $hole }}]" data-hole="{{ $hole }}" style="max-width: 70px; border-radius: 6px; border: 1px solid #8DA66E; background: #f8fafc; text-align: center;" title="Yardage for {{ $tee->tee_name }} - Hole {{ $hole }}">
                                            </td>
                                            @if ($hole == 9)
                                            <td style="background: #8DA66E; color: #fff; font-weight: bold; padding: 0.5rem;">{{ array_sum(array_slice($yardages[$tee->tee_id], 0, 9)) }}</td>
                                            @endif
                                            @endforeach
                                            <td style="background: #8DA66E; color: #fff; font-weight: bold; padding: 0.5rem;">{{ array_sum(array_slice($yardages[$tee->tee_id], 9, 9)) }}</td>
                                            <td style="background: #2F4A3C; color: #8DA66E; font-weight: bold; padding: 0.5rem;">{{ array_sum($yardages[$tee->tee_id]) }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                    ...
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden mb-4 scorecard-section-card" style="background: #fff; border: 1px solid #e0e8d8;">
                        <div class="card-header py-2 px-4 d-flex align-items-center justify-content-between" style="background: #f8fafc; color: #2F4A3C; border-bottom: 1px solid #e0e8d8;">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <span class="fw-bold" style="font-size: 1.15rem; color: #2F4A3C;">Par & Handicap Index</span>
                            </div>
                            <span class="badge" style="background-color: #e0e8d8; color: #5E7C4C;">Hole Configuration</span>
                        </div>
                        <div class="card-body p-4">
                            <div class="table-responsive">
                                <table class="table table-bordered align-middle text-center mb-0 table-hover scorecard-table" style="min-width: 1100px;">
                                    <thead style="background: #f0f4f0; color: #2F4A3C;">
                                        <tr>
                                            <th class="fw-bold" style="color: #5E7C4C; background: #e8e8e8; width: 12%;">Hole Attr.</th>
                                            @foreach($frontNine as $hole)
                                            <th style="background: #f0f4f0; font-size: 0.9rem;">{{ $hole }}</th>
                                            @endforeach
                                            <th style="background: #8DA66E; color: #fff; font-weight: bold;">OUT</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="par-row" style="background-color: #f9faf9;">
                                            <td class="fw-bold" style="color: #5E7C4C; background: #e8e8e8; padding: 0.75rem;">PAR</td>
                                            @for ($i = 1; $i <= 18; $i++)
                                                <td style="padding: 0.75rem;">
                                                <input type="number" value="{{ $i+5 }}" class="form-control form-control scorecard-input par-input" name="par[{{ $i }}]" data-hole="{{ $i }}" style="width: 100%; border-radius: 6px; border: 2px solid #8DA66E; background: #f8fafc; text-align: center; padding: 0.6rem 0.4rem; font-weight: 600; font-size: 1rem;" title="Par for Hole {{ $i }}">
                                                </td>
                                                @if ($i == 9)
                                                <td style="background: #8DA66E; color: #fff; padding: 0.75rem;"></td>
                                                @endif
                                                @endfor
                                                <td style="background: #8DA66E; color: #fff; padding: 0.75rem;"></td>
                                                <td style="background: #2F4A3C; color: #8DA66E; padding: 0.75rem;"></td>
                                        </tr>
                                        {{-- Men's Handicap --}}
                                        <tr class="male-handicap-row" style="background-color: #f9faf9;">
                                            <td class="fw-bold" style="color: #5E7C4C; background: #e8e8e8; padding: 0.75rem;">M Handicap</td>
                                            @for ($i = 1; $i <= 18; $i++)
                                                <td style="padding: 0.75rem;">
                                                <input type="number" value="{{ $i+1 }}" class="form-control form-control scorecard-input" name="male_handicap[{{ $i }}]" data-hole="{{ $i }}" style="width: 100%; border-radius: 6px; border: 2px solid #8DA66E; background: #f8fafc; text-align: center; padding: 0.6rem 0.4rem; font-weight: 600; font-size: 1rem;" title="Men's Handicap Index for Hole {{ $i }}">
                                                </td>
                                                @if ($i == 9)
                                                <td style="background: #8DA66E; color: #fff; padding: 0.75rem;"></td>
                                                @endif
                                        ...
                                        <tr class="ladies-handicap-row" style="background-color: #f9faf9;">
                                            <td class="fw-bold" style="color: #5E7C4C; background: #e8e8e8; padding: 0.75rem;">W Handicap</td>
                                            @for ($i = 1; $i <= 18; $i++)
                                                <td style="padding: 0.75rem;">
                                                <input type="number" value="{{ $i + 2 }}" class="form-control form-control scorecard-input" name="ladies_handicap[{{ $i }}]" data-hole="{{ $i }}" style="width: 100%; border-radius: 6px; border: 2px solid #8DA66E; background: #f8fafc; text-align: center; padding: 0.6rem 0.4rem; font-weight: 600; font-size: 1rem;" title="Women's Handicap Index for Hole {{ $i }}">
                                                </td>
                                                @if ($i == 9)
                                                <td style="background: #8DA66E; color: #fff; padding: 0.75rem;"></td>
                                                @endif
